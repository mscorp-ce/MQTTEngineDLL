...
uses
  ...
  FireDAC.Stan.Error, uConfigParser, uModel.FireDACEngineException;
...
begin
  ...
  try
    ...
    FConexao.DriverName                := TConfigParser.GetINI('DATA_MSSMQL', 'DriverName');
    FConexao.Params.Values['Server']   := TConfigParser.GetINI('DATA_MSSMQL', 'Server');
    FConexao.Params.Values['Database'] := TConfigParser.GetINI('DATA_MSSMQL', 'Database');
    FConexao.Params.Values['User_Name']:= TConfigParser.GetINI('DATA_MSSMQL', 'User_Name');
    FConexao.Params.Values['Password'] := TConfigParser.GetINI('DATA_MSSMQL', 'Password');
